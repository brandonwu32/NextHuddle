...
import { fetchFilteredDevelopers } from '@/app/lib/data';

export default async function DevelopersTable({
  query,
  currentPage,
}: {
  query: string;
  ...
  const developers = await fetchFilteredDevelopers(query, currentPage);
              ...
              >
                ...
                <div className="flex w-full items-center justify-between pt-4">
                  ...
                  <div className="flex justify-end gap-2">
                    <UpdateTeam id={developer.id} />
                    <DeleteTeam id={developer.id} />
                  </div>
                </div>
              </div>
            ))}
              ...
              {developers?.map((developer) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    {/* <p>{developer.total_tasks}</p> */}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    {/* <p>{developer.pending_tasks}</p> */}
                  </td>
